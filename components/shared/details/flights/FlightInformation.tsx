  ...
  return (
    <div className={`bg-light-900 flex flex-col gap-4 px-6 py-8 rounded shadow ${props.className}`}>
      ...
      <div className="flex flex-row justify-between">
        <span className="h2-bold">{mockFlightData.direction} {`${daysOfWeek[departure.getDay()]}, ${monthsOfYear[departure.getMonth()]} ${departure.getDate()}`}</span>
      ...
      <div className="flex flex-col items-center gap-8 self-center md:flex-row md:gap-16">
        <div className="flex flex-row items-center justify-between gap-4">
          <span
            className="h2-semibold">{departure.getUTCHours().toString().padStart(2, '0')}:{departure.getUTCMinutes().toString().padStart(2, '0')}</span>
        ...
        <div className="flex flex-row items-center justify-between gap-4">
          <span
            className="h2-semibold">{arrival.getUTCHours().toString().padStart(2, '0')}:{arrival.getUTCMinutes().toString().padStart(2, '0')}</span>
