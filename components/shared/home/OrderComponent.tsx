    ...
    <div>
        <div className='relative'>
            ...
            <div className='absolute w-[389px] flex flex-col justify-center items-center bottom-0 my-12 mx-20'>
                ...
                <p className='mt-2 h3-regular text-white text-center'>Search Flights & Places Hire to our most popular destinations</p>
                <button className='flex justify-center items-center rounded-md gap-x-1 px-4 py-3 mt-2 bg-primary-100'>
                    <span>
                        <Image
